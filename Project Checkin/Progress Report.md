...
## Outcomes
- IoT device categories decided on and formalized
...
- Built draft scoring matrices for each device category to support the visual scoring framework
- Created initial draft of process flow diagram to integrate into final report
